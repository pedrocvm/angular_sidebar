...
// <reference types="angular" />
 ...
 export interface IDropdownConfigNgOptions extends angular.INgModelOptions {
 ...
 export interface IDatepickerCellArgs {
        date: Date;
        mode: DatepickerMode;
    }
 ...
 export interface IDatepickerPopupConfig extends IDatepickerConfig {
 ...
 export interface IModalProvider extends angular.IServiceProvider {
        /**
 ...
 export interface IModalInstanceService {
     ...
     */
 export interface IModalServiceInstance extends IModalInstanceService { }
 ...
 export interface IModalStackService {
        /**
 ...
 export interface IModalStackedMapKeyValuePair {
 ...
 export interface ITooltipProvider extends angular.IServiceProvider {
        /**
 ...
 export interface ITransitionServiceOptions {
        animation?: boolean;
    }
